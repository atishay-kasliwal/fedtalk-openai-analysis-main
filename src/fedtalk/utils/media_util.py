...
AUDIO_BASE_PATH = "data/raw/data_1Min/audio/"
VIDEO_BASE_PATH = "data/raw/data_1Min/video/"
RESULTS_BASE_PATH = "data/raw/data_1Min/results/"
...
def get_asr_model():
    """Lazily loads the Whisper model on first use instead of at import time."""
    global _asr_model
...
def extract_speech(audio_file: str) -> str:
    ...
    transcription = get_asr_model().transcribe(audio_file)
...
import pandas as pd
def combine_weighted_accuracy():
    """One-off script that combines negative-case and news-case accuracy summaries into a weighted average."""
    # Load the two metrics summary CSV files
    negative_metrics_file = "data/raw/data_1Min/analysis/same_minute_news_predictions_insights_minute55.csv"
    news_metrics_file = "data/raw/data_1Min/analysis/same_time_negative_predictions_insights_minute55.csv"

...
if __name__ == "__main__":
    # Example usage: split a video into chunks, then extract frames at intervals.
    # Replace these paths with your own input/output locations.
    split_video("data/raw/data_5Min/video/example.mp4", "data/raw/data_5Min/video/partitions")
    process_videos_in_folder(
        input_folder="data/raw/data_5Min/video/partitions",
        interval_sec=10,
        output_base_folder="data/raw/data_5Min/video/frames",
    )
